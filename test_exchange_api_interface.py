...
args_from_test1_1 = exchange_api_interface.GetBalanceResults(
    False, "", {"omg": 1.22222, "gnt": 0})
result_from_test1_1 = (False, "balance value type")
args_from_test1_2 = exchange_api_interface.GetBalanceResults(
    False, "", {"omg": 1.22222, "gnt": -0.1})
result_from_test1_2 = (False, "balance value negative")
args_from_test1_3 = exchange_api_interface.GetBalanceResults(
    False, "", {"omg": 1.22222, "gnt": 1.1})
result_from_test1_3 = (True, True)
args_from_test1_4 = exchange_api_interface.TradeResults(False, "", 123)
result_from_test1_4 = (True, True)
args_from_test1_5 = exchange_api_interface.TradeResults(False, "", 123.1)
